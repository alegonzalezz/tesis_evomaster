...
/**
 * This file was automatically generated by EvoMaster on 2024-03-10T22:02:26.782Z[Etc/UTC]
 * <br>
...
public class EvoMaster_Test {
    ...
    */
    ...
    public void test_0() throws Exception {
        List<InsertionDto> insertions0 = sql().insertInto("ITEM", 4L)
                .d("ID", "-1483596887")
                .d("COST", "NULL")
                .d("DESCRIPTION", "\"_EM_16_XYZ_\"")
                .d("NAME", "\"_EM_17_XYZ_\"")
            .dtos();
        ...
        given().accept("*/*")
                ...
                .get(baseUrlOfSut + "/api/items/-1483596887?EMextraParam123=42")
                .then()
                .statusCode(200)
                .assertThat()
                .contentType("application/json")
                .body("'name'", containsString("_EM_17_XYZ_"))
                .body("'description'", containsString("_EM_16_XYZ_"))
                .body("'cost'", nullValue());
    ...
    public void test_1() throws Exception {
        List<InsertionDto> insertions = sql().insertInto("ITEM", 5L)
                .d("ID", "-16777187")
                .d("COST", "NULL")
                .d("DESCRIPTION", "NULL")
                .d("NAME", "\"_EM_20_XYZ_\"")
            .and().insertInto("ITEM", 6L)
                .d("ID", "343")
                .d("COST", "-906237708")
                .d("DESCRIPTION", "\"_EM_21_XYZ_\"")
                .d("NAME", "\"youVIGkk7BRQYu\"")
            .dtos();
        ...
        ValidatableResponse res_0 = given().accept("*/*")
                ...
                .contentType("application/json")
                .body("size()", equalTo(2))
                .body("[0].'name'", containsString("_EM_20_XYZ_"))
                .body("[0].'description'", nullValue())
                .body("[0].'cost'", nullValue())
                .body("[1].'name'", containsString("youVIGkk7BRQYu"))
                .body("[1].'description'", containsString("_EM_21_XYZ_"))
                .body("[1].'cost'", numberMatches(-9.06237708E8));
    ...
    public void test_4() throws Exception {
        ...
        ValidatableResponse res_0 = given().accept("*/*")
                ...
                .contentType("application/json")
                .body(" null ")
                .post(baseUrlOfSut + "/api/items?EMextraParam123=_EM_27_XYZ_")
                .then()
                .statusCode(400)
                .assertThat()
                .contentType("application/json")
    ...
    public void test_5() throws Exception {
        ...
        given().accept("*/*")
                .header("x-EMextraHeader123", "")
                .get(baseUrlOfSut + "/api/items/137?EMextraParam123=_EM_0_XYZ_")
                .then()
                .statusCode(404)
                .assertThat()
                .body(isEmptyOrNullString());
