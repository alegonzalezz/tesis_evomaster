...
/**
 * This file was automatically generated by EvoMaster on 2024-04-12T13:29:29.299Z[Etc/UTC]
 * <br>
...
public class EvoMaster_Test {
    ...
    */
    ...
    public void test_0() throws Exception {
        List<InsertionDto> insertions0 = sql().insertInto("ITEM", 74L)
                .d("ID", "69")
                .d("COST", "NULL")
                .d("DESCRIPTION", "NULL")
                .d("NAME", "NULL")
        ...
        given().accept("*/*")
                ...
                .get(baseUrlOfSut + "/api/items/69?EMextraParam123=_EM_164_XYZ_")
                .then()
                .statusCode(200)
                .assertThat()
    ...
    public void test_1() throws Exception {
        List<InsertionDto> insertions = sql().insertInto("ITEM", 16L)
                .d("ID", "736")
                .d("COST", "801")
                .d("DESCRIPTION", "NULL")
                .d("NAME", "\"RaUkqfGRk\"")
        ...
        ValidatableResponse res_0 = given().accept("*/*")
                ...
                .contentType("application/json")
                .body("size()", equalTo(1))
                .body("[0].'name'", containsString("RaUkqfGRk"))
                .body("[0].'description'", nullValue())
                .body("[0].'cost'", numberMatches(801.0));
    ...
    public void test_3() throws Exception {
        ...
        given().accept("*/*")
                ...
                .contentType("application/json")
                .body(" { " + 
                    " \"description\": \"_EM_102_XYZ_\", " + 
                    " \"id\": 767 " + 
                    " } ")
                .post(baseUrlOfSut + "/api/items?EMextraParam123=_EM_104_XYZ_")
                .then()
                .statusCode(201)
                .assertThat()
    ...
    public void test_5() throws Exception {
        ...
        given().accept("*/*")
                .header("x-EMextraHeader123", "")
                .get(baseUrlOfSut + "/api/items/-1814469221?EMextraParam123=_EM_0_XYZ_")
                .then()
                .statusCode(404)
                .assertThat()
                .body(isEmptyOrNullString());
